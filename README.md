...
<p align="center">
  <a href="release-notes/v1.0.2.md"><img src="https://img.shields.io/badge/version-1.0.2-007AFF" alt="Version 1.0.2"></a>
...
Download [Uplink 1.0.2](https://github.com/SuperSonnix71/uplink-releases/releases/download/v1.0.2/Uplink-1.0.2.dmg) or read the [release notes](release-notes/v1.0.2.md).

Version 1.0.2 fixes the release link and bundled licenses button in About. Install this version over the old copy. Your saved connections and credentials are kept.
...
Version 1.0.2 uses internal build 7. Installation of a downloaded update through Check for Updates still needs testing.
